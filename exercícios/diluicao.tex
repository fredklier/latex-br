...
\begin{multicols}{2}
	...
	\question Aqueceu-se um frasco contendo uma solução aquosa de \ce{CuSO4} $5 \times 10^{-2}$ mol/L. O aquecimento foi interrompido quando restavam 100 mL de uma solução aquosa de \ce{CuSO4} 1,2 mol/L. Determine o volume da solução inicial e o volume da água perdida pelo aquecimento. \makeemptybox{2cm}
