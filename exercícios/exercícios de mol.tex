...
%	\usepackage{fourier-otf} %transforma a fonte utilizada no latex
	...
	\firstpageheader{}{}{}
	\runningheader{}{}{} \firstpagefooter{\class}{\examnum\ - Page \thepage\ of \numpages}{\term}
	\firstpagefootrule
	...
	\begin{Huge}
	\fbox{
	[substância]=\eme =$\frac{n_1}{V_{(l)}} =\frac{m_1}{M_1  \ast  V_{(l)}} $
	}
	\end{Huge}
	\end{center}
	...
	\hline
	 $n^{\circ}$ de mol & soluto & solvente & solução  \\ \hline
	 representação & $n_1$ & $n_2$ & n \\  \hline
	\end{tabular}
	\end{table}
