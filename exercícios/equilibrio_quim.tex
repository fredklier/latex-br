...
\begin{multicols}{2}
	\begin{questions}
			...
			\question Qual a Concentração de íons sulfato formados em uma solução 			de 1 litro com 0,1 mol de $BaSO_4 (K_s = 1,0 \cdot 10^{-10})$?
			\begin{oneparchoices}
					\choice $1,0 \cdot 10^{-2}$
					\choice $1,0 \cdot 10^{-3}$
					\choice $1,0 \cdot 10^{-4}$
					\choice $1,0 \cdot 10^{-5}$
					\choice $1,0 \cdot 10^{-6}$
			\end{oneparchoices}

			\question Qual a Concentração de íons sulfato formados em uma solução 			de 1 litro com 1 mol de $Ca_3(PO_4)_2 (K_s = 1,0 \cdot 10^{-25})$?\\
				\begin{oneparchoices}
						\choice $1,0 \cdot 10^{-6}$
						\choice $1,0 \cdot 10^{-5}$
						\choice $1,0 \cdot 10^{-4}$
